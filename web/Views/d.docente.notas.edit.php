<?php
include("../Controllers/d.controller.docente.notas.edit.php");
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Estudiante: <?php echo $estudiante['nombres']." ".$estudiante['paterno']; print_r($nota);?></h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="observacion" value="<?php echo $ConsultaNota['observacion'];?>" name="observacion">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="username" class="col-sm-3 text-end control-label col-form-label">Nota</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" value="<?php echo $ConsultaNota['nota'];?>" id="nota" name="nota" placeholder="">
                                        </div>
                                    </div>
                                ...
                                <div class="border-top" align="center">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="<?php echo $ConsultaNota['id']; ?>">
