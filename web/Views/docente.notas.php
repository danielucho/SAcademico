<?php
include("../Controllers/controller.docente.notas.php");
                            ...
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <?php
                                        if (isset($MostrarNota['observacion'])) {
                                        ?>
                                            <input type="text" class="form-control" id="observacion" value="<?php echo $MostrarNota['observacion'];?>" name="observacion" placeholder="">
                                        </div>
                                        <?php
                                        }else{?>
                                        <input type="text" class="form-control" id="observacion" value="Ninguna" name="observacion" placeholder="">
                                        <?php
                                        }
                                        ?>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <?php
                                        if (isset($MostrarNota['nota'])) {
                                        ?>
                                        <input type="text" class="form-control" id="nota" value="<?php echo $MostrarNota['nota']."/100";?>" name = "nota"> 
                                        <?php
                                        }else{?>
                                        <td>0/100</td>
                                        <?php
