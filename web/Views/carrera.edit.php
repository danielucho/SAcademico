<?php
include("../Controllers/controller.carrera.edit.php");
                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" class="form-control" <?php echo $id;?> id="id" name="id"></input>

                                    <div class="form-group row">
                                        <label for="cod_carrera" class="col-sm-3 text-end control-label col-form-label">Código</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="cod_carrera" value="<?php echo $cod_carrera;?>" name="cod_carrera" placeholder="Código de la Carrera">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="nombre" class="col-sm-3 text-end control-label col-form-label">Nombre</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nombre" value="<?php echo $nombre;?>" name="nombre" placeholder="Nombre de la Carrera">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" id="tipo_carrera" name="tipo_carrera">
                                                <option><?php echo $tipo_carrera;?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="nivel_carrera" id="nivel_carrera">
                                                <option><?php echo $nivel_carrera;?></option>
                                                <optgroup label="Nivel de la Carrera">
                                                <option>TÉCNICO BASICO</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="duracion" id="duracion">
                                                <option><?php echo $duracion;?></option>
